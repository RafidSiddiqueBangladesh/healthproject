...
class LiquidGlassTopNavBar extends StatelessWidget {
  const LiquidGlassTopNavBar({
    super.key,
    required this.currentIndex,
    required this.onTap,
  });
  ...
  static const _items = <(IconData, String)>[
    ...
    (Icons.fitness_center_rounded, 'Exercise'),
    (Icons.health_and_safety_rounded, 'Health'),
    (Icons.videocam_rounded, 'Live'),
    (Icons.person_rounded, 'Profile'),
    (Icons.kitchen_rounded, 'Cooking'),
    (Icons.analytics_rounded, 'Cost'),
  ];
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: List.generate(_items.length, (index) {
            ...
            final iconColor = isSelected ? Colors.white : const Color(0xFFB6D9DD);
            final bgColor = isSelected ? const Color(0x50FFFFFF) : const Color(0x19FFFFFF);
                ...
                child: InkWell(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(18),
                      border: Border.all(
                        color: Colors.white.withValues(alpha: isSelected ? 0.44 : 0.2),
                      ),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(item.$1, size: 18, color: iconColor),
